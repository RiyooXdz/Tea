...
exports.menunya = (salam, pushname, botname) =>{
	return`Hai Bang... ${pushname} 👋 
Selamat ${salam} 
Saya ${botname} 
Bot Ini Adalah Bot Multi-Device🥳
Yang Dibuat Oleh Owner Saya 😇

╭──「 𝐎𝐖𝐍𝐄𝐑 」
│❏  𝘕𝘢𝘮𝘢 : 𝘙𝘪𝘺𝘰
│❏  𝘜𝘮𝘶𝘳 : 17 𝘠𝘦𝘢𝘳𝘴 𝘖𝘭𝘥
│❏   𝘈𝘴𝘬𝘰𝘵 : 𝘑𝘢𝘸𝘢𝘣𝘢𝘳𝘢𝘵, 𝘊𝘪𝘢𝘮𝘪𝘴
│❏ 𝘎𝘦𝘯𝘥𝘳𝘦 : 𝘓𝘢𝘬𝘪 - 𝘓𝘢𝘬𝘪
╰────
╭─ [ 𝐌𝐲 𝐒𝐨𝐬𝐢𝐚𝐥 𝐌𝐞𝐝𝐢𝐚 ]
│❏  𝘠𝘰𝘶𝘛𝘶𝘣𝘦 : https://bit.ly/3GtHDNH
│❏  𝘐𝘯𝘴𝘵𝘢𝘨𝘳𝘢𝘮 : https://bit.ly/3LXHbZa
│❏  𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 : https://bit.ly/38XiKxx
│❏ 𝘛𝘦𝘭𝘦𝘨𝘳𝘢𝘮 : https://t.me/riyoxdz
│❏ 𝘍𝘢𝘤𝘦𝘣𝘰𝘰𝘬 : https://bit.ly/3a1hMRc
╰────
╭─ [ 𝐃𝐨𝐧𝐚𝐬𝐢 𝐊𝐚𝐤 𝐁𝐮𝐚𝐭 𝐉𝐚𝐣𝐚𝐧 𝐄𝐬 ]
...
4. Jangan Spam Bot Di Grup 😉
Sanksi : *BOT LEAVE/KELUAR*
...
⚠️ Segala kebijakan dan ketentuan Minami Bot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan MinamiBot
😖🙏
`
}
exports.welcome = () =>{
